...
<%
	...
	try{
		...
		String query1 = "insert into addressbook (name, phone, address, email, relation) values (?, ?, ?, ?, ?)";
	...
	RequestDispatcher dispatcher = request.getRequestDispatcher("AddressBook_04.jsp");
