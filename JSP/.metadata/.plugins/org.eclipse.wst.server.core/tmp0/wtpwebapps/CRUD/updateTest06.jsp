...
<%request.setCharacterEncoding("utf-8"); %>
	...
	<form name="Member" action="updateTest07.jsp" method="post">
	ID : <input type="text" name="name" size="15" value="<%=userid %>" readonly="readonly"> <br>
	NAME : <input type="text" name="name" size="10" value="<%=name %>"> <br>
	TEL : <input type="text" name="tel" size="15" value="<%=tel %>"> <br>
